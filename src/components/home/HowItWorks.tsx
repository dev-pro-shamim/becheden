        ...
        <div className="grid md:grid-cols-3 gap-8 lg:gap-12 relative">
          ...
          {steps.map(({ icon: Icon, key }, index) => (
            <div key={key} className="relative flex flex-col items-center text-center group">
              {/* Step Number & Icon */}
              <div className="relative z-10 flex h-16 w-16 items-center justify-center rounded-lg bg-card border-2 border-border dark:border-primary/30 shadow-lg shadow-primary/10 transition group-hover:shadow-xl group-hover:shadow-primary/20 group-hover:-translate-y-1 group-hover:border-primary">
