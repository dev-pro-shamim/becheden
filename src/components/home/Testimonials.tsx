      ...
      <div className="custom-width mx-auto px-4 lg:px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {testimonials.map((item) => (
            <div
              key={item.name}
              className="group relative rounded-lg border border-border/50 bg-card p-6 transition-all hover:shadow-lg hover:shadow-primary/5 hover:-translate-y-1 hover:border-primary/30"
            >
              {/* Quote Icon */}
