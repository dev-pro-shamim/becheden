...
const socials = [
  { label: "Facebook", href: "https://www.facebook.com/share/191DuH2ySB/?mibextid=wwXIfr", icon: Facebook },
...
const Footer = () => {
  ...
  const contactDetails = [
    {
      icon: MapPin,
      label: "Dhaka New Market",
      description: "Dhaka New Market Biswash Builders C Tower/12",
    },
    {
      icon: Phone,
      label: "+8801540-581895",
      description: t("supportHours"),
      href: "tel:+8801540581895",
    },
    {
      icon: Mail,
      label: "info@becheden.com",
